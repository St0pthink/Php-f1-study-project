...
<html>
    ...
    <div class="wrapper">
        <main class="content">   
            ...
            <h1 class="my-3">
                <i class="fas fa-rss"></i> Лента друзей
            </h1>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-6">
                            <div class="empty-feed">
                                ...
                                <h3>Лента пуста</h3>
                                <p class="text-muted">
                                    У вас пока нет друзей, или ваши друзья ещё не создали карточки.<br>
                                    <a href="{{ route('users.browse') }}">Найти друзей</a>
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        @foreach ($drivers as $driver)
                            <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-3 col-xxxl-2 d-flex mb-5">
                                <div class="card cd w-100 h-100" 
                                    ...
                                    <div class="card-body">
                                        <h2 class="card-title">
                                            <a href="{{ route('drivers.show', $driver) }}" class="title-link">{{ $driver->title }}</a>
                                        </h2>
                                        <p class="card-text">
                                            {{ $driver->short_description }}
                                        </p>
                                        <small class="text-muted d-block mt-2">
                                            <i class="fas fa-user"></i> {{ $driver->user->name ?? 'Неизвестно' }}
                                            &bull;
                                            <i class="fas fa-clock"></i> {{ $driver->created_at->format('d.m.Y') }}
                                        </small>
                                    </div>
                                </div>
                            </div>
